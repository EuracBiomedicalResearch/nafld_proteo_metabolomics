...
- violin plot of BMI of the data split by sex and SLD type. to evaluate whether
  there is a strong difference in BMI between MASLD and CTRL - we might then
  eventually add that variable also to the linear model?
- same plot for age.
- maybe also a PCA of the data.
...
plot_volcano(results, "sld_typeMASLD", main = "MASLD vs CTRL")
grid()
